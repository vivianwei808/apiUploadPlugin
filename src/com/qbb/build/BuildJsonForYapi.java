...
public class BuildJsonForYapi {
     ...
     * @date: 2019/2/19
     */
    public static void getRequest(Project project, YapiApiDTO yapiApiDTO, PsiMethod psiMethodTarget) throws Exception {
     ...
     * @date: 2019/2/19
     */
    public static String getResponse(Project project, PsiType psiType, String returnClass) throws Exception {
    ...
    public static KV getPojoJson(Project project, PsiType psiType) throws Exception {
     ...
     * @return: com.com.ww.qbb.build.KV
     * @author: chengsheng@qbb6.com
     * @date: 2019/5/15
     */
